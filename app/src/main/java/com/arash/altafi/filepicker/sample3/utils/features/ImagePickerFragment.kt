...
import com.arash.altafi.filepicker.databinding.EfFragmentImagePickerBinding
import com.arash.altafi.filepicker.sample2.util.parcelable
import com.arash.altafi.filepicker.sample2.util.parcelableArrayList
import com.arash.altafi.filepicker.sample3.utils.features.camera.CameraHelper.checkCameraAvailability
import com.arash.altafi.filepicker.sample3.utils.features.fileloader.DefaultImageFileLoader
import com.arash.altafi.filepicker.sample3.utils.features.recyclers.RecyclerViewManager
import com.arash.altafi.filepicker.sample3.utils.helper.ConfigUtils
import com.arash.altafi.filepicker.sample3.utils.helper.ImagePickerPreferences
import com.arash.altafi.filepicker.sample3.utils.helper.ImagePickerUtils
import com.arash.altafi.filepicker.sample3.utils.helper.IpLogger
import com.arash.altafi.filepicker.sample3.utils.helper.state.fetch
...
class ImagePickerFragment : Fragment() {
    ...
    private val config: ImagePickerConfig by lazy {
        requireArguments().parcelable(ImagePickerConfig::class.java.simpleName)!!
    }
    ...
    override fun onCreateView(
        ...
        val selectedImages = if (savedInstanceState == null) {
            ...
            savedInstanceState.parcelableArrayList(STATE_KEY_SELECTED_IMAGES)
        }
        ...
        if (savedInstanceState != null) {
            recyclerViewManager.onRestoreState(savedInstanceState.parcelable(STATE_KEY_RECYCLER))
        }
