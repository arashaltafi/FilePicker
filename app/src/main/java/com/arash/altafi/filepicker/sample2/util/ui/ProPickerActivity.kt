package com.arash.altafi.filepicker.sample2.util.ui
...
import com.arash.altafi.filepicker.sample2.util.DialogProgress
import com.arash.altafi.filepicker.sample2.util.ProPicker
import com.arash.altafi.filepicker.sample2.util.ProviderHelper
...
internal class ProPickerActivity : AppCompatActivity() {
    ...
    private fun prepareGallery() {
        val d = if (providerHelper.isToCompress())
            DialogProgress.showProgressDialog(this, "Compressing....", false)
        else DialogProgress.showProgressDialog(this, "Processing....", false)
