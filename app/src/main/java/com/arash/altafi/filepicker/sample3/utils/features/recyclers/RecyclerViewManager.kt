package com.arash.altafi.filepicker.sample3.utils.features.recyclers
...
import com.arash.altafi.filepicker.sample3.utils.adapter.FolderPickerAdapter
import com.arash.altafi.filepicker.sample3.utils.adapter.ImagePickerAdapter
...
import com.arash.altafi.filepicker.sample3.utils.features.IpCons
...
import com.arash.altafi.filepicker.sample3.utils.listeners.OnImageClickListener
import com.arash.altafi.filepicker.sample3.utils.listeners.OnImageSelectedListener
...
import com.arash.altafi.filepicker.sample3.utils.view.GridSpacingItemDecoration
    ...
    fun selectImage(isSelected: Boolean): Boolean {
        if (config.mode == ImagePickerMode.MULTIPLE) {
            if (imageAdapter.selectedImages.size >= config.limit && !isSelected) {
                Toast.makeText(context, "Image selection limit", Toast.LENGTH_SHORT).show()
                return false
            }
