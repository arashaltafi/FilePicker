...
import com.arash.altafi.filepicker.sample3.utils.helper.IpCrasher
...
class ImagePickerActivity : AppCompatActivity(), ImagePickerInteractionListener {
    ...
    private val config: ImagePickerConfig? by lazy {
        intent.extras!!.parcelable(ImagePickerConfig::class.java.simpleName)
    }

    private val cameraOnlyConfig: CameraOnlyConfig? by lazy {
        intent.extras?.parcelable(CameraOnlyConfig::class.java.simpleName)
    }
