...
//        }
    ...
    public override fun onRestoreInstanceState(state: Parcelable) {
        if (state is Bundle) {
            ...
            super.onRestoreInstanceState(bundle.parcelable("instanceState"))
            return
        }
    ...
    private fun fitImageToView() {
        ...
        if (!isZoomed && !imageRenderedAtLeastOnce) {
            ...
            floatMatrix!![Matrix.MTRANS_X] = newTranslationAfterChange(
                transX,
                prevActualWidth,
                actualWidth,
                prevViewWidth,
            ...
            floatMatrix!![Matrix.MTRANS_Y] = newTranslationAfterChange(
                transY,
                prevActualHeight,
                actualHeight,
                prevViewHeight,
    ...
    private fun scaleImage(
        ...
        touchMatrix!!.postScale(
            deltaScaleLocal.toFloat(),
            deltaScaleLocal.toFloat(),
            focusX,
            focusY
        )
