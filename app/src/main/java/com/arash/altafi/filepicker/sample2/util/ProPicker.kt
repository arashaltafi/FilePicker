...
import com.arash.altafi.filepicker.sample2.util.model.ImageProvider
import com.arash.altafi.filepicker.sample2.util.model.Picker
import com.arash.altafi.filepicker.sample2.util.ui.ProPickerActivity
...
object ProPicker {
    ...
    fun getSelectedPickerDatas(intent: Intent) =
        intent.parcelableArrayList<Picker>(EXTRA_SELECTED_IMAGES) ?: ArrayList()
    ...
    class Builder(private val activity: Activity) {
        ...
        */
        ...
        private fun showImageProviderDialog(completionHandler: ((resultCode: Int, data: Intent?) -> Unit)? = null) {
            ...
            v.findViewById<MaterialTextView>(R.id.btnCamera).setOnClickListener {
                imageProvider = ImageProvider.CAMERA
                start(completionHandler)
                d.dismiss()
            }

            v.findViewById<MaterialTextView>(R.id.btnGallery).setOnClickListener {
