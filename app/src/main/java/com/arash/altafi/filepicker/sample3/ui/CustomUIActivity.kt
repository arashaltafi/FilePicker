...
import com.arash.altafi.filepicker.databinding.ActivityCustomUiBinding
...
import com.arash.altafi.filepicker.sample3.utils.features.ImagePickerFragment
import com.arash.altafi.filepicker.sample3.utils.features.ImagePickerInteractionListener
...
import com.arash.altafi.filepicker.sample3.utils.helper.ViewUtils
...
class CustomUIActivity : AppCompatActivity() {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        config = intent.extras?.parcelable(ImagePickerConfig::class.java.simpleName)
        cameraOnlyConfig = intent.extras?.parcelable(CameraOnlyConfig::class.java.simpleName)
